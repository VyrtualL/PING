...
import fr.epita.assistants.myide.domain.service.ProjectService_model;
...
public class MyIde {
    ...
    public static ProjectService init(final Configuration configuration) {
        ProjectService project_service = new ProjectService_model(configuration.indexFile, configuration.tempFolder);
